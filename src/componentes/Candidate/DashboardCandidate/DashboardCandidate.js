...
import LoginCandidate from "../LoginCandidate/LoginCandidate";
  ...
  return (
    <>
      ...
      >
        ...
        <div
          style={isVisibleSidebar ? {} : { width: "100vw" }}
          className={isVisibleSidebar ? "dashboard-app" : ""}
        >
          <header
            style={
              isVisibleSidebar
          ...
          >
            <div className="row profile-container w-100">
              <div
                className={
                  isVisibleSidebar
                    ? "toggle col-sm-3 col-md-3 my-3"
                    : "col-sm-3 col-md-3 my-3"
                }
              >
                <button
                  onClick={handleIsVisibleSidebar}
              ...
              <div
                className={
                  isVisibleSidebar
                    ? "col-sm-6 col-md-7 "
                    : "col-sm-6 col-md-7 blankSpaceCenter"
                }
              ></div>
              <div
                className={
                  isVisibleSidebar
                    ? "col-sm-3 col-md-auto image-container my-3 form-inline d-flex flex-nowrap"
                    : "col-sm-3 col-md-auto image-container my-3 form-inline d-flex flex-nowrap"
                }
              >
                <p
                  className="candidate-text text-dark d-flex justify-content-center align-items-center"
                  style={{ marginRight: "20px" }}
                >{isUserLoggedIn ?  `${name} ${last_name}` :
                  "Candidato" }
                </p>
                <img
                  style={
                  ...
                  src= {isUserLoggedIn ? avatar_url : imgProfile }
                  alt="profile-pic"
