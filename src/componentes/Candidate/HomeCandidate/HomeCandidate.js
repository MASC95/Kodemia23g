...
const urlImg1 ='https://frontjobinderimg.s3.amazonaws.com/DreamShaper_v7_estate_agent_working_hard_in_office_while_his_a_2.jpg';
const urlImg2 ='https://frontjobinderimg.s3.amazonaws.com/DreamShaper_v7_estate_agent_working_hard_in_office_reading_a_p_0.jpg';
      ...
      >
        <Carousel.Item className=" ">
          ...
          <Carousel.Caption className="">
            <h3
              style={{ fontSize: `${myFontSize}`, color: "white" }}
