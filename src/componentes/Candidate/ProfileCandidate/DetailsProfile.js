      ...
      <div className="row container_form_General">
        ...
        <div className="col">
          <div className="row mb-4">
            ...
            <div className="col">
              <div className="form-outline bg-gray">
                <label className="form-label text-start" for="form6Example1">
                  Nombre
                </label>
                <p className="">JIM</p>
              </div>
          ...
          <div className="buttons-actions d-flex justify-content-end gap-3">
            <button
              type="button"
              className="buttons btn btn-success text-light"
            >
              Aceptar
            </button>
            <button type="button" className="buttons btn btn-danger text-light">
              Ignorar
            </button>
          </div>
        </div>
