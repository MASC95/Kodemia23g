      ...
      <Carousel className="w-100 main-carousel d-sm-block h-100">
        <Carousel.Item className="carousel-img">
          ...
          <Carousel.Caption className="carousel-text">
            <h2
              className="welcome-text animate__animated animate__heartBeat animate__delay-2s d-flex justify-content-center align-items-center d-sm-inline small"
              style={{ fontSize: "7vw" }}
            >
              Welcome to Jobinder{" "}
            </h2>
